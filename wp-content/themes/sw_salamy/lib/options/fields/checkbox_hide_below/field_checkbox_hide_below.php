...
class YA_Options_checkbox_hide_below extends YA_Options{	
	...
	*/
	function render(){
		...
		echo '<input type="checkbox" id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" value="1" class="'.$class.' ya-opts-checkbox-hide-below" '.checked($this->value, '1', false).' />';
