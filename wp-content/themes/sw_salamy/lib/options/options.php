...
// 					);
					...
					foreach($section['fields'] as $fieldk => $field){
						...
						if(isset($field['validate'])){
							...
							if(!class_exists($validate)){
								include_once (YA_URL.'options/validation/'.$field['validate'].'/validation_'.$field['validate'].'.php');
							}//if
		...
		public function _options_form(){
			echo '<form method="post" id="cpanel-form" action="'.get_bloginfo('wpurl').'" enctype="multipart/form-data" class="form-horizontal">';
			...
			echo '<script type="text/javascript"> cpanel_name = "'.$this->args['opt_name'].'"; </script>';
				...
				?>
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<?php echo $icon . $section['title']; ?>
							</a>
						</div>
						<div id="<?php echo $section_id; ?>" class="panel-collapse collapse<?php echo $i==1 ? ' in' : ''; ?>">
