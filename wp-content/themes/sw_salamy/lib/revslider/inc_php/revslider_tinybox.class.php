...
class RevSlider_TinyBox {
	...
	public static function my_add_tinymce_plugin($plugin_array) {
		...
		if($version<3.9)
			$plugin_array['revslider'] = get_template_directory_uri().'/lib/revslider/js/tbld.js';
		else
			$plugin_array['revslider'] = get_template_directory_uri().'/lib/revslider/js/tbld-3.9.js';
