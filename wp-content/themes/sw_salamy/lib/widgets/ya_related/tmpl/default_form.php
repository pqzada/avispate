...
<p>
	<label for="<?php echo $this->get_field_id('showposts'); ?>"><?php _e('Number of Posts', 'yatheme')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('length'); ?>"><?php _e('Length of excerpt', 'yatheme')?></label>
	<br />
	<input class="widefat"
