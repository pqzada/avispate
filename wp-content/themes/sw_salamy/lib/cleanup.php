...
function ya_gallery($attr) {
	...
	$output = '<ul id="photobox-gallery-' . $instance . '" class="thumbnails photobox-gallery gallery gallery-columns-'.$columns.'">';
	...
	foreach ($attachments as $id => $attachment) {
		...
		$output .= '<li style="width: '.$width.'%;">' . $link;
		if (trim($attachment->post_title)) {
			$output .= '<div class="caption"><strong>' . wptexturize($attachment->post_title) . '</strong></div>';
		}
		$output .= '</li>';
	}
