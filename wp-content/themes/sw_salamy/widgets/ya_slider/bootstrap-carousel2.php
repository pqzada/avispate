...
?>
	<script type="text/javascript">
		yaCarousel = {} ;
		yaCarousel['<?php echo $this->id; ?>'] = {
			interval : <?php echo $interval; ?>,
		};
	</script>
<div class="widget-slider">
	<div class="yaslider carousel slide style2" id="<?php echo $this->id; ?>" data-interval="<?php echo $interval; ?>">
		<!-- If select post ID -->
		...
		<?php } ?>
			<div class="carousel-nav">
				<a href="#<?php echo $this->id; ?>" data-slide="prev" class="carousel-control left"><i class="icon-angle-left"></i></a>
				<a href="#<?php echo $this->id; ?>" data-slide="next" class="carousel-control right"><i class="icon-angle-right"></i></a>
			</div>
	</div>
</div>
	<?php 
