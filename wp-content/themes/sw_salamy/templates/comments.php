...
function ya_comment($comment, $args, $depth) {
	$GLOBALS['comment'] = $comment; ?>
  	<div id="comment-<?php comment_ID(); ?>" <?php comment_class('media btn'); ?>>
  		<div class="author">
...
<?php if (have_comments()) : ?>
	...
	<?php if (!comments_open() && !is_page() && post_type_supports(get_post_type(), 'comments')) : ?>
		<div class="alert alert-block fade in">
			<a class="close" data-dismiss="alert">&times;</a>
			<p><?php _e('Comments are closed.', 'yatheme'); ?></p>
		</div>
	<?php endif; ?>
</section><!-- /#comments -->
<?php endif; ?>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" name="commentform" onsubmit="return submitform()" class="form-horizontal row-fluid">		
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<img id="slide-img-1" src="<?php echo get_bloginfo('template_directory');?>/assets/img/cmm-add.png" class="slide" alt="" />
				</span>
		...
		<div class="control-group">
			...
			<img id="slide-img-1" src="<?php echo get_bloginfo('template_directory');?>/assets/img/cmm-mail.png" class="slide" alt="" />
			</span>
        ...
        <div class="control-group">				
				<div class="controls">
				<span class="icon-url">
				<img id="slide-img-1" src="<?php echo get_bloginfo('template_directory');?>/assets/img/cmm-url.png" class="slide" alt="" />
				</span>
