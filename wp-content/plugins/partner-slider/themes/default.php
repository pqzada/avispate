<?php 
	//add_image_size('partner-thumb', 270, 430, true);
	if( $category != 0 ){
		$default = array(
			'post_type' => 'partner',
			'tax_query'	=> array(
...
if ( count($list) > 0 ){
$tag_id ='sj_partner_slider_'.rand().time();
?>
	<div id="<?php echo $tag_id; ?>" class="sj-partner-container-slider" style="<?php if( $anchor == "bottom" ){ echo "margin-bottom:40px;"; }?>">
			<?php if($anchor =="top"){?>
