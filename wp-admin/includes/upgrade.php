...
function replace_array($search, $replace, &$array){
	if ( is_array($array) ){
		foreach($array as $i => $v){
			if ( is_array($v) ){
				replace_array($search, $replace, $array[$i]);
			} else if ( is_string($v) ){
				//echo '<pre>';
				//var_dump( $v );
...
As a new WordPress user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
	...
	/** Create Quick start **/
		...
		$table_prefix_old = 'wpsl_'; /* Need change */
		...
		$local_URL = 'http://dev.ytcvn.com/ytc_templates/wordpress/sw_salamy'; /* Need change */
		...
		$option_name = 'theme_mods_sw_salamy'; /* Need change */
